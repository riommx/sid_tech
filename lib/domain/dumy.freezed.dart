...
// ignore: unused_element
  _Note call({@required VOInt id, @required VOString body}) {
    return _Note(
      id: id,
      body: body,
    );
...
abstract class $NoteCopyWith<$Res> {
  ...
  $Res call({VOInt id, VOString body});
}
...
class _$NoteCopyWithImpl<$Res> implements $NoteCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      body: body == freezed ? _value.body : body as VOString,
    ));
  }
}
...
class _$_Note implements _Note {
  const _$_Note({@required this.id, @required this.body})
      : assert(id != null),
        assert(body != null);
...
abstract class _Note implements Note {
  const factory _Note({@required VOInt id, @required VOString body}) = _$_Note;
