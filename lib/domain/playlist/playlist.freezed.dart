...
abstract class $PlaylistCopyWith<$Res> {
  ...
  $Res call({VOInt id, VOString name, VOKtList<VOInt> tracks});
}
...
class _$PlaylistCopyWithImpl<$Res> implements $PlaylistCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      tracks: tracks == freezed ? _value.tracks : tracks as VOKtList<VOInt>,
    ));
  }
}
...
abstract class _Playlist extends Playlist {
  ...
  const factory _Playlist(
      {@required VOInt id,
      @required VOString name,
      @required VOKtList<VOInt> tracks}) = _$_Playlist;
