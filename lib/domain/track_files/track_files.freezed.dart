...
// ignore: unused_element
  _TrackFiles call({@required VOInt id, @required VOKtList<VOString> files}) {
    return _TrackFiles(
      id: id,
      files: files,
    );
...
abstract class $TrackFilesCopyWith<$Res> {
  ...
  $Res call({VOInt id, VOKtList<VOString> files});
}
...
class _$TrackFilesCopyWithImpl<$Res> implements $TrackFilesCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      files: files == freezed ? _value.files : files as VOKtList<VOString>,
    ));
  }
}
...
abstract class _TrackFiles extends TrackFiles {
  ...
  const factory _TrackFiles(
      {@required VOInt id, @required VOKtList<VOString> files}) = _$_TrackFiles;
